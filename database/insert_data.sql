...
INSERT INTO KHOA (MaKhoa, TenKhoa, DienThoai, Email) VALUES
    ('CNTT',  N'Công nghệ thông tin',  '0241000001', 'cntt@hvcs.edu.vn'),
    ('KT',    N'Kinh tế',              '0241000002', 'kinhte@hvcs.edu.vn'),
    ('CK',    N'Cơ khí',               '0241000003', 'cokhi@hvcs.edu.vn'),
    ('VHNT',  N'Văn hóa - Nghệ thuật', '0241000004', 'vhnt@hvcs.edu.vn'),
    ('QTKD',  N'Quản trị kinh doanh',  '0241000005', 'qtkd@hvcs.edu.vn');
...
-- ---------------------------------------------------------
-- 4. TAIKHOAN
--    Tài khoản hệ thống (admin, cb, gv) + tài khoản sinh viên mẫu
-- ---------------------------------------------------------
INSERT INTO TAIKHOAN (MaTK, TenDangNhap, MatKhau, TrangThai, MaVaiTro) VALUES
    ...
    -- Tài khoản hiển thị màn hình tpl-accounts
...
-- ---------------------------------------------------------
-- 7. CUOCTHI
--    Khớp với dữ liệu hiển thị trong tpl-contests và tpl-dashboard
-- ---------------------------------------------------------
INSERT INTO CUOCTHI (MaCuocThi, TenCuocThi, LoaiCuocThi, DonViToChuc, DiaDiem, ThoiGianBatDau, ThoiGianKetThuc, SoLuongToiDa, MoTa, TrangThai, MaGV) VALUES
    ('CT001', N'Olympic Tin học 2025',   N'Học thuật',   N'Khoa CNTT',  N'Hội trường A',  '2025-05-25 08:00', '2025-05-25 17:00', 100, N'Cuộc thi Olympic Tin học thường niên', N'Đang mở',      'GV001'),
    ('CT002', N'NCKH Sinh viên 2025',    N'NCKH',        N'Phòng KHCN', N'Phòng B201',    '2025-06-02 08:00', '2025-06-02 17:00', 100, N'Nghiên cứu khoa học sinh viên 2025',   N'Mở sớm',       'GV001'),
    ('CT003', N'Khởi nghiệp Startup',    N'Khởi nghiệp', N'Đoàn TN',   N'Online',         '2025-06-10 08:00', '2025-06-10 17:00',  80, N'Cuộc thi ý tưởng khởi nghiệp',         N'Sắp đóng',     'GV002'),
    ...
    ('CT005', N'Thể thao học kỳ 2',      N'Thể thao',    N'Phòng CTCT',N'Sân vận động',  '2025-06-20 07:00', '2025-06-20 17:00', 200, N'Hội thao sinh viên học kỳ 2',           N'Mở sớm',       'GV001');

-- ---------------------------------------------------------
-- 8. DANGKY_THAMGIA
--    Khớp dữ liệu tpl-registration, tpl-participants, tpl-cancel-registration
-- ---------------------------------------------------------
